...
Proof.
  intro p. destruct p as [n m]. rewrite <- snd_fst_is_swap. reflexivity.
Qed.
(** [] *)
...
Proof.
  intros. induction l1 as [|h t Ihl].
...
Proof.
  simpl. intros. rewrite -> eqb_id_refl. reflexivity.
Qed.
(** [] *)
