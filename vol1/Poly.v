...
match l with 
|nil => (nil, nil)
|(h1, h2) :: t => match (split t) with |(l1, l2) => (h1::l1, h2::l2) end
end.
...
Proof.
  ...
  + reflexivity.
  + simpl.
    assert (H : forall (T1 T2 : Type) (l1 l2 : list T1) (g : T1 -> T2), 
...
Definition exp (n m : cnat) : cnat :=  
  fun X s z =>
    m (X -> X) (fun h => fun h' => n X h h') (fun z => s z) z.
